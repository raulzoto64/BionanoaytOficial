  ...
  return (
    <div className="space-y-6">
      <div className="bg-emerald-50 p-4 rounded-lg border border-emerald-100 flex items-center gap-4">
        ...
        <div>
          <h3 className="text-lg font-semibold text-emerald-900">Editor de Ecosistema</h3>
          <p className="text-sm text-emerald-700">Participantes, redes y colaboraciones.</p>
        </div>
      </div>

      <Button onClick={onAddSection} className="bg-emerald-600 text-white hover:bg-emerald-700">
        <Plus className="w-4 h-4 mr-2" />
        Añadir Sección a Ecosistema
      </Button>
