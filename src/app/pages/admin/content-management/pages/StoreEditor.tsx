  ...
  return (
    <div className="space-y-6">
      <div className="bg-blue-50 p-4 rounded-lg border border-blue-100 flex items-center gap-4">
        ...
        <div>
          <h3 className="text-lg font-semibold text-blue-900">Editor de Tienda</h3>
          <p className="text-sm text-blue-700">Configura el catálogo y promociones.</p>
        </div>
      </div>

      <Button onClick={onAddSection} className="bg-blue-600 text-white hover:bg-blue-700">
        <Plus className="w-4 h-4 mr-2" />
        Añadir Sección a Tienda
      </Button>
